				...
				<div className="row">
					...
					<div className="header-menu d-none d-xl-block">
						...
						<div className="ltn__main-menu go-top">
							...
							<li><Link to="/contact">Nos Produits</Link></li>
							<li><Link to="/contact">Vert Essentiel</Link></li>
							</ul>
						</div>
						</nav>
					</div>
					...
					<div className="header-search-wrap">
   						 <form id="#" method="get" action="#">
     						   <div className="search-container">
       						     <input type="text" name="search"  placeholder="Search here..." id='txt_s' />
                    ...
                    <div className="ltn__main-menu go-top">
							...
							<li><Link to="/contact" id='contact'>contactez-Nous</Link></li>
							</ul>
						</div>
					{/* user-menu */}

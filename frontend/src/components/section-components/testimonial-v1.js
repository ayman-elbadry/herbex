...
class Testimonial extends Component {
    ...
    return <div className="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-70" style={{ backgroundColor: '#d4eccc' }}>
			  <div className="container">
			    <div className="row">
			      <div className="col-lg-12">
			        <div className="section-title-area ltn__section-title-2--- text-center">
			          <h1 className="section-title">Vos Expériences avec HERBEXbio</h1>
					  <p>Rejoignez notre communauté et vivez l'expérience HERBEXbio.</p>
			        </div>
			      </div>
			    </div>
